...
# TODO: around april 2027, update node versions.
# Newer nodeenv (1.11?) will have option for --node=22 instead of exact version
nodeenv --node=22.12.0 $MIRTE_SRC_DIR/mirte-web-interface/node_env
