#!/bin/dash
# Copied from: https://raw.githubusercontent.com/ev3dev/ev3-systemd/ev3dev-buster/scripts/ev3-usb.sh
# EDITED: serial num, as it didn't work with newer kernels
...
# TODO: get new usb vid:pid from https://pid.codes/
...
ev3_usb_up() {
	...
	serial="10" # AJ: just some random serial num
